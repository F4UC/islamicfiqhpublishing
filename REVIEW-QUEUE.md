...
- **scholar quotes (.ar-quote):** อัลกะซานีย์, อัลอัศกาฟีย์, อิบนุ อาบิดีน ×หลายช่วง, อันนะวาวีย์ ×2 — **ทุกบล็อกลงสระครบใน source → R60 keep voweled (all-or-nothing satisfied, ไม่ strip)** คง byte-exact
- **หะดีษ:** `أُحِلَّ لَنَا مَيْتَتَانِ...` ฝังในคำพูดอันนะวาวีย์ → footnote ref-3 (takhrij Ibn Majah 3314, เศาะฮีฮ์)

### ⚑ ต้องอนุมัติ/ท้วงติง
- [ ] **⚑ R77 / nested-aya (FLAG — แยกไม่ออกอย่างปลอดภัย):** scholar quotes (อัลกะซานีย์, อิบนุ อาบิดีน) มี **อายะฮ์แทรกในตัวบท** (รูปฉบับพิมพ์ `الطَّيِّبَاتِ`/`{أوْ دَمًا مَسْفُوحًا}`) และมีจุด `.` ลาติน + `اهـ.` ปนใน scholar prose — **คงตัวบท scholar byte-exact (ไม่แตะ)** → ขอ Claude ตัดสิน: re-fetch span อายะฮ์ในตัว scholar / normalize `.` ลาติน หรือคงไว้
- [ ] **⚑ R8 / hadith wording (FLAG):** สำนวนหะดีษในคำพูดอันนะวาวีย์ = `فَالسَّمَكُ` (al-Majmu') ≠ sunnah.com Ibn Majah 3314 = `فَالْحُوتُ` (ริวายะฮ์ต่างสำนวน) → คงสำนวนอันนะวาวีย์ (ไม่ทับ เพราะจะบิดเบือนคำพูดปราชญ์), อ้าง takhrij ใน bib · ขอยืนยันแนวทาง
...
- [ ] **⚑ ชื่อปราชญ์ "อัลอัศกาฟีย์":** น่าจะเป็น al-Haskafi (الحصكفي ผู้แต่ง الدر المختار) — **คงตาม source (R1/R3)**, FLAG ขอยืนยัน (อาจควรเป็น "อัลหัศกะฟีย์")
