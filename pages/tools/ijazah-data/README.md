...
- `ijaza_demo` (bab: "โครงสร้างสายอิญาซะฮ์ (ตัวอย่าง)") เป็น **สายตัวอย่างเชิงโครงสร้าง**
  ใช้ชื่อสมมุติ ไม่ใช่สนัดจริง — **ลบไฟล์ `graphs/ijaza_demo.json` ออกแล้ว** (ตามมติเจ้าของ)
  รายการที่แสดงจริงเหลือ 22 สาย
- หมายเหตุ: `index.json` (ต้นทาง byte-exact) ยังมี entry `ijaza_demo` อยู่ จึง **คงตัวกรอง
  รันไทม์** `gid !== 'ijaza_demo'` ใน `ijazah-network.html` ไว้เป็นกันชน (ไม่ให้ entry ค้าง
  โผล่ในลิสต์/ยิง 404) จนกว่าจะมีสายแทนที่จริงจากเจ้าของ
