...
## จุดทำต่อ (RESUME)
- **RESUME: pid 964** (เล่ม 3 หน้า 172; **AH 3 · muntazam-h3-017.json** · hijriYear=3 ceYear=624 unit=hijri-y3 order=17) — ต่ออุหุด (pid 963 จบที่หัมนะฮ์ บินต์ ญะห์ช; pid 964 เริ่มด้วยสายรายงานอัลมุหัมมะดาน→...): เหตุการณ์หลังอุหุด/บทกวีไว้อาลัย/ฆอซวะฮ์หัมรออุลอะซัด → วะฟะยาต AH 3 → السنة الرابعة. **สถานะ 286 ชาร์ด (hijri-y3:16), glossary 4226/690** · **อุหุด h3-007..016 ครบแล้ว** (จัดทัพ→รบ→พลิกผัน→ท่านนบีบาดเจ็บ→อุบัยย์/มุศอับ→หัมซะฮ์→ชะฮีด→ฝัง) · battle page = 1-3 event/หน้า, byte-gate+tm_qc(ratio≥0.6)+ref-validate ทุกชาร์ด · **บทเรียน: excerpt ต้องจบตรงที่คำแปลจบ — ถ้า T3 ratio<0.6 = excerpt ยาวเกินคำแปล ให้ตัด excerpt ที่ isnad ถัดไป** · เช็ค raw nass ตอนขึ้นปีใหม่ (c4)
