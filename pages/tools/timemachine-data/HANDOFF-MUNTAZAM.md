...
## จุดทำต่อ (RESUME)
- **RESUME: pid 952** (เล่ม 3 หน้า 160; **AH 3 · ไฟล์ muntazam-h3-005.json** · hijriYear=3, ceYear=624, era=hijri, unit=hijri-y3, order=5) — ต่อเหตุการณ์ AH 3: หลังฆอซวะฮ์บนีสุลัยม์ที่บุห์รอน → เหตุการณ์/ฆอซวะฮ์ที่เหลือของปีที่ 3 (คาด: อุหุด ปลายปี) → วะฟะยาต AH 3. loc=เล่ม 3 หน้า [pid-792]. **★ หัวปีอยู่ใน c4 (clean ตัด) — เช็ค raw nass ทุกครั้งที่สงสัยขึ้นปีใหม่ (السنة الرابعة ฯลฯ) แล้วสลับ unit=hijri-yN + order รีเซ็ต 1** · pid ว่าง len 0 ข้ามได้ · ref persons/places ตรง glossary id ก่อนเขียน (mecca ไม่ใช่ makka; abd-allah-b-abbas ไม่ใช่ ibn-abbas)
