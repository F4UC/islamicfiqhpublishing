...
## จุดทำต่อ (RESUME)
- **RESUME: pid 1016 (AH 5, h5-011, order=11)** — ต่อหะดีษอัลอิฟก์ (การชำระบริสุทธิ์ อันนูร 24:11+). ★เช็ค len SEG เต็มก่อนแปล (T3). unit=hijri-y5 hijriYear=5 ceYear=626. ✅ AH 4 เสร็จ h4-001..017
