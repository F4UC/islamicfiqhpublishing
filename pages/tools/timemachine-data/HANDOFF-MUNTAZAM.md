...
## ตัวเลขปัจจุบัน
- **★ branch ใหม่ `claude/timemachine-muntazam-3`** (แตกสดจาก origin/main หลัง PR #301 squash-merge เข้า main แล้ว) · tip `ef19eb0e` (+banner) · push/sync · tree สะอาด
...
- **delta บน branch นี้ = 49 ชาร์ดใหม่:** `pre-170`..`pre-218` (pre-02..pre-169 อยู่ใน main แล้ว) · **glossary 4064 persons / 667 places** · ★มรณกรรมเคาะดีญะฮ์/อันศอรเริ่มอิสลามที่อะเกาะบะฮ์ (pre-198..218) · **PR #315 เปิดแล้ว (One เปิด, open, head ตรง tip)**
