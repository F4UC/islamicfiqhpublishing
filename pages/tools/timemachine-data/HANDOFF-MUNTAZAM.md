...
## ตัวเลขปัจจุบัน
- **★ branch ใหม่ `claude/timemachine-muntazam-3`** (แตกสดจาก origin/main หลัง PR #301 squash-merge เข้า main แล้ว) · tip `5b516ad2` (+banner) · push/sync · tree สะอาด
...
- **delta บน branch นี้ = 16 ชาร์ดใหม่:** `pre-170`..`pre-185` (pre-02..pre-169 อยู่ใน main แล้ว) · **glossary 3992 persons / 652 places** · **PR #315 เปิดแล้ว (One เปิด, open, head ตรง tip)**
