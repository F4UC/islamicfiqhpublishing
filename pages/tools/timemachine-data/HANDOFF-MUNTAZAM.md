...
## ตัวเลขปัจจุบัน
- **★ branch ใหม่ `claude/timemachine-muntazam-3`** (แตกสดจาก origin/main หลัง PR #301 squash-merge เข้า main แล้ว) · tip `9bed0745` (+banner) · push/sync · tree สะอาด
...
- **delta บน branch นี้ = 48 ชาร์ดใหม่:** `pre-170`..`pre-217` (pre-02..pre-169 อยู่ใน main แล้ว) · **glossary 4059 persons / 667 places** · ★ฏออิฟ/แต่งงานอาอิชะฮ์/มรณกรรมเคาะดีญะฮ์ (pre-198..217) · **PR #315 เปิดแล้ว (One เปิด, open, head ตรง tip)**
