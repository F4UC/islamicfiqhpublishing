...
## จุดทำต่อ (RESUME)
- **RESUME: pid 1018 (AH 5, h5-013, order=13)** — ต่อเรื่องซัยด์/ซัยนับ บินต์ ญะห์ช (อัลอะห์ซาบ ทะบันนี) → ค็อนดัก/บนีกุร็อยเซาะฮ์. ★เช็ค len SEG เต็มก่อนแปล (T3). unit=hijri-y5 hijriYear=5 ceYear=626
