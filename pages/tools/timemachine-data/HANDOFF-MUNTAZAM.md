...
## จุดทำต่อ (RESUME)
- **RESUME: pid 870** (เล่ม 3 หน้า 78; **AH 1 · ไฟล์ muntazam-h1-012.json** · hijriYear=1, era=hijri, unit=hijri-y1) — ต่อ★หลังอะซาน: รายละเอียดรุอ์ยาอะซาน(อับดุลลอฮ์ บิน ซัยด์/อุมัร)/สนธิสัญญากับยะฮูด(เศาะฮีฟะฮ์)/จบเหตุการณ์ปีที่1→เข้าปีที่2 · loc=เล่ม 3 หน้า [pid-792] → อับดุลมุฏฏ็อลิบเลี้ยง → มรณะอับดุลมุฏฏ็อลิบ → อบู ฏอลิบเลี้ยง → พบบาทหลวงบะฮีรอ → ฮัรบุลฟิญาร → ฮิลฟุลฟุฎูล → แต่งเคาะดีญะฮ์ → สร้างกะอ์บะฮ์/ตัดสินหินดำ → เผยพระวจนะ ...
