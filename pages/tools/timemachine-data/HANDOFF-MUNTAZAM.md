...
## ตัวเลขปัจจุบัน
- **★ branch ใหม่ `claude/timemachine-muntazam-3`** (แตกสดจาก origin/main หลัง PR #301 squash-merge เข้า main แล้ว) · tip `0a0c8cc4` (+banner) · push/sync · tree สะอาด
...
- **delta บน branch นี้ = 52 ชาร์ดใหม่:** `pre-170`..`pre-221` (pre-02..pre-169 อยู่ใน main แล้ว) · **glossary 4069 persons / 670 places** · ★★อิสรออ์-มิอ์รอจ+ฟัรฎฺละหมาด (pre-198..221) · **PR #315 เปิดแล้ว (One เปิด, open, head ตรง tip)**
