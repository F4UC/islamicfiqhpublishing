...
## จุดทำต่อ (RESUME)
- **RESUME: pid 910** (เล่ม 3 หน้า 118; **AH 2 · ไฟล์ muntazam-h2-012.json** · hijriYear=2, ceYear=623, era=hijri, unit=hijri-y2, order=12) — ต่อ★★บัดร์: มลาอิกะฮ์ลงช่วยต่อ/กอลีบบัดร์(ท่านเรียกชื่อศพในบ่อ)/กลับมะดีนะฮ์/แบ่งของเชลย/รายชื่อชะฮีดบัดร์. loc=เล่ม 3 หน้า [pid-792] → อับดุลมุฏฏ็อลิบเลี้ยง → มรณะอับดุลมุฏฏ็อลิบ → อบู ฏอลิบเลี้ยง → พบบาทหลวงบะฮีรอ → ฮัรบุลฟิญาร → ฮิลฟุลฟุฎูล → แต่งเคาะดีญะฮ์ → สร้างกะอ์บะฮ์/ตัดสินหินดำ → เผยพระวจนะ ...
