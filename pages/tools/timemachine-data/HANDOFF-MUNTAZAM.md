...
## จุดทำต่อ (RESUME)
- **RESUME: pid 958** (เล่ม 3 หน้า 166; **AH 3 · ไฟล์ muntazam-h3-011.json** · hijriYear=3, ceYear=624, unit=hijri-y3, order=11) — กลางสมรภูมิอุหุด (ต่อ pid 957 ที่อิบนุ เกาะมีอะฮ์เงื้อดาบ): มรณกรรมหัมซะฮ์/มุศอับ บิน อุมัยร์, การล้อมป้องท่านนบี, ข่าวลือท่านนบีตาย, ถอยขึ้นเขา → จบอุหุด → ชะฮีดอุหุด → ฆอซวะฮ์หัมรออุลอะซัด → วะฟะยาต AH 3 → السنة الرابعة. **สถานะ: 280 ชาร์ด (hijri-y3:10), glossary 4221/689** · แพตเทิร์น: battle page = 1 event/หน้า (notable-only glossary), ชื่อรองทับศัพท์ในเนื้อ · เช็ค raw nass ตอนสงสัยขึ้นปีใหม่ (c4 หัวปี)
