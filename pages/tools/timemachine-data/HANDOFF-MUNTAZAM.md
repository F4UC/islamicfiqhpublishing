...
- **สถานะ main ล่าสุด:** ทุกชาร์ดถึง **h2-019 (pid 932) merge เข้า main แล้ว** (PR #314+#315) · **delta บน muntazam-4 = h2-020..h2-026 (pid 933-942, 7 ชาร์ด — บทมรณกรรม/ชีวประวัติอุมัยยะฮ์ บิน อบิศเศาะลต์ครบ)** · **glossary 4197 persons / 679 places** · al-muntazam 265 ชาร์ด (hijri-y1:14 + hijri-y2:26 + pre-series) · ทุกชาร์ดผ่าน byte-gate (re-fetch) + tm_qc + ref-validate (persons/places)
...
## จุดทำต่อ (RESUME)
- **RESUME: pid 943** (เล่ม 3 หน้า 151; **AH 2 · ไฟล์ muntazam-h2-027.json** · hijriYear=2, ceYear=623, era=hijri, unit=hijri-y2, order=27) — บทอุมัยยะฮ์ บิน อบิศเศาะลต์จบที่ pid 942 (h2-026) แล้ว; pid 943 ต่อการอภิปรายบทกวีอุมัยยะฮ์ (สำนวนอบู อุบัยดะฮ์ มะอ์มัร บิน อัลมุษันนา/อัลอัศมะอี) → แล้วเข้าเหตุการณ์ AH 2 ที่เหลือ → السنة الثالثة (AH 3). loc=เล่ม 3 หน้า [pid-792]. **หมายเหตุ pid 934 ว่างเปล่า (len 0) ข้ามได้** · **ตรวจ ref persons/places ให้ตรง glossary id ก่อนเขียนไฟล์เสมอ** (mecca ไม่ใช่ makka, abd-allah-b-abbas ไม่ใช่ ibn-abbas)
