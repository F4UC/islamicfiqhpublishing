...
## ตัวเลขปัจจุบัน
- **★ branch ใหม่ `claude/timemachine-muntazam-3`** (แตกสดจาก origin/main หลัง PR #301 squash-merge เข้า main แล้ว) · tip `e3234fee` (+banner) · push/sync · tree สะอาด
...
- **delta บน branch นี้ = 42 ชาร์ดใหม่:** `pre-170`..`pre-211` (pre-02..pre-169 อยู่ใน main แล้ว) · **glossary 4050 persons / 665 places** · ★มับอัษ→อิสลามหัมซะฮ์/ฆุลิบะติรฺรูม (pre-198..211) · **PR #315 เปิดแล้ว (One เปิด, open, head ตรง tip)**
