...
## จุดทำต่อ (RESUME)
- **RESUME: pid 1007 (AH 5!, h5-002, order=2)** — ต่อสาเหตุซาตุรริกออ์ (อันมาร-ษะอ์ละบะฮ์). ✅ AH 4 เสร็จครบ h4-001..017 (วะฟะยาต #74-91). ★ หัวปี AH 5 อยู่ใน c4 (เช็ค nass ดิบ). unit=hijri-y5 hijriYear=5 ceYear=626 (เล่ม 3 หน้า 197; **AH 4 · muntazam-h4-001.json** · hijriYear=4 ceYear=625 era=hijri unit=hijri-y4 order=1) — **AH 3 (السنة الثالثة) เสร็จครบ h3-001..041** (ปีอุหุด: เหตุการณ์→รบ→ชะฮีด 73 คน). **pid 989 = السنة الرابعة เริ่ม** (หัวปีอยู่ใน matn คราวนี้: «ثم دخلت سنة أربع من الهجرة») → สะรียะฮ์อบู สะละมะฮ์ที่ก็อฏ็อน/สะรียะฮ์อับดุลลอฮ์ บิน อุนัยส์สังหารสุฟยาน บิน คอลิด/บิอ์รมะอูนะฮ์/บนีนะฎีร/ฯลฯ. **h4: hijriYear=4 ceYear=625 unit=hijri-y4 order เริ่ม 1.** **สถานะ 311 ชาร์ด (hijri-y3:41), glossary 4280/692** · แพตเทิร์น: roster 1-3 event/หน้า notable-only, byte-gate+tm_qc(ratio≥0.6)+ref-validate ทุกชาร์ด · **★ split marker: ใช้ harakat-stripped finder** (clean text บาง span ไม่มีสระ ทำให้ voweled marker ไม่ match) · เช็ค raw+clean ตอนขึ้นปีใหม่ (AH4 หัวปีใน matn ต่างจาก AH3 ที่อยู่ c4)
