...
## จุดทำต่อ (RESUME)
- **RESUME: pid 1017 (AH 5, h5-012, order=12)** — ✅ อัลอิฟก์เสร็จ (h5-008..011). ต่อ AH 5 (ค็อนดัก/บนีกุร็อยเซาะฮ์…). ★เช็ค len SEG เต็มก่อนแปล (T3). unit=hijri-y5 hijriYear=5 ceYear=626. ✅ AH 4 เสร็จ h4-001..017
