...
## จุดทำต่อ (RESUME)
- **RESUME: pid 1015 (AH 5, h5-010, order=10)** — ต่อหะดีษอัลอิฟก์ (คุฏบะฮ์ท่านนบี→อันนูร 24 ชำระบริสุทธิ์). ★เช็ค len SEG เต็มก่อนแปล (T3). unit=hijri-y5 hijriYear=5 ceYear=626. ✅ AH 4 เสร็จ h4-001..017
