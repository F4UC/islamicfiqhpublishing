...
## จุดทำต่อ (RESUME)
- **RESUME: pid 1013 (AH 5, h5-008, order=8)** — ต่อ AH 5 → เหตุมุนาฟิก (อิบนุอุบัย «الأعز يخرج الأذل»)/อัลอิฟก์/ค็อนดัก. unit=hijri-y5 hijriYear=5 ceYear=626. ✅ AH 4 เสร็จ h4-001..017
