...
## ตัวเลขปัจจุบัน
- **★ branch ใหม่ `claude/timemachine-muntazam-3`** (แตกสดจาก origin/main หลัง PR #301 squash-merge เข้า main แล้ว) · tip `c8e66ad9` (+banner) · push/sync · tree สะอาด
...
- **delta บน branch นี้ = 4 ชาร์ดใหม่:** `pre-170` + `pre-171` + `pre-172` + `pre-173` (pre-02..pre-169 อยู่ใน main แล้ว) · **glossary 3958 persons / 645 places**
- ตรวจผ่านครบ: **tm_qc 0 findings (pre-170..173) · 0 ★ · 0 em-dash · byte-gate ทุก shard (re-fetch)** · S11 ok · R5/R52/R89/R92
