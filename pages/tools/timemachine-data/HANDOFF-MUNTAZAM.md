...
## จุดทำต่อ (RESUME)
- **RESUME: pid 1014 (AH 5, h5-009, order=9)** — ต่อหะดีษอัลอิฟก์ (เศาะฟวานพากลับ→อิบนุอุบัยใส่ความ→อันนูร 24 ชำระบริสุทธิ์). unit=hijri-y5 hijriYear=5 ceYear=626. ✅ AH 4 เสร็จ h4-001..017
