...
## จุดทำต่อ (RESUME)
- **RESUME: pid 961** (เล่ม 3 หน้า 169; **AH 3 · muntazam-h3-014.json** · hijriYear=3 ceYear=624 unit=hijri-y3 order=14) — ต่ออุหุด (pid 960 จบที่อุมัรจะตอบอบู สุฟยาน): บทสนทนาอบู สุฟยาน-อุมัร «อุบลุ ฮุบัล/อัลลอฮุอะอ์ลา», สภาพหลังรบ, มรณกรรมหัมซะฮ์รายละเอียด/ฮินด์, ชะฮีดอุหุด 70, ฝังชะฮีด, ฆอซวะฮ์หัมรออุลอะซัด, วะฟะยาต AH 3 → السنة الرابعة. **สถานะ 283 ชาร์ด (hijri-y3:13), glossary 4221/690** · battle page = 1-3 event/หน้า (notable-only), byte-gate+tm_qc+ref-validate ทุกชาร์ด · เช็ค raw nass ตอนขึ้นปีใหม่ (c4)
