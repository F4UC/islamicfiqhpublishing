...
บทความใหม่หลัง shia-takfir ไม่จำเป็นต้องมี hero image ตอน publish — เผยแพร่โดยยังไม่มีรูปแล้วเติม hero เป็น batch ภายหลังได้ หากไม่มี hero ให้ละ feature-image block ทั้งก้อนออก (ห้ามคง <img> ที่ชี้ไฟล์ไม่มีจริง เพราะจะ 404) โครงอื่นทั้งหมด (cb- control bar, ar-blocks, alignment, reading-time, citation) ยังต้องครบตาม golden master ส่วน moon-sighting และ shia-takfir ที่มี hero แล้วให้คงไว้

**Rule 68 — Arabic↔Thai block spacing (แคบและสม่ำเสมอ)**
ระยะห่างแนวตั้งระหว่างบล็อก Arabic (ar-quote / ar-feature / hadith-block / aya-block / block-ar) กับย่อหน้าไทยที่ติดกัน (ทั้ง intro ที่ลงท้ายด้วย ":" ด้านบน และ ar-translation ด้านล่าง) ต้องแคบและเท่ากันทุกจุด กำหนดค่ากลางครั้งเดียวใน article.css (margin บน=ล่างเท่ากันสำหรับบล็อก Arabic ทุกชนิด) ห้ามตั้ง margin เฉพาะจุดที่ทำให้ระยะไม่สม่ำเสมอ และ line-height ของบล็อก Arabic ไม่ควรกว้างเกินจำเป็น เนื่องจากเป็น CSS ร่วม การปรับนี้มีผลกับทุกบทความพร้อมกัน (รวม moon-sighting)
