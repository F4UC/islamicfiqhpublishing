...
- [ ] **House style ร้อยแก้วไทย (S1–S9 — ไทยเท่านั้น ห้ามแตะอาหรับ):**
...
- [ ] **(S10 — placeholder, linter งานแยก · ★Arabic-block ไม่ใช่ Thai-only★):** เครื่องหมายวรรคตอน**ในบล็อกอาหรับ**เป็นแบบอาหรับ `،` `؟` `؛` ไม่ใช่ลาติน (Rule 77) — ★อยู่ใต้อำนาจ §3 (Arabic byte-exact) ไม่ใช่ house-style ไทย; aya/hadith = re-fetch, scholar Arabic = normalize+log · ดู §3★
