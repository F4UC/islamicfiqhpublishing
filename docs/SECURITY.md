...
- การ harden CSP (เช่น ย้ายไป nonce/hash) เป็นงานใหญ่ระดับสถาปัตยกรรม — **ต้องได้รับอนุมัติจาก One ก่อนเท่านั้น** ห้ามเอเยนต์ตัดสินใจเอง · แผนเป็นเฟส (เริ่มจาก report-only ความเสี่ยงศูนย์): **`docs/csp-hardening-roadmap.md`**
