...
|---|---|
| อายะฮ์อัลกุรอาน, หะดีษ (ตัวบท), นิยามศัพท์แกนที่กำลังวิเคราะห์ — **ความยาว ≤ 280 ตัวอักษร** | **แสดงเต็ม** (บล็อก `.ar-feature` — **จัดกึ่งกลาง ไม่มีเส้นขอบด้านข้าง**) |
...
```
CSS แนะนำ (มาตรฐานรวม — **จัดกึ่งกลาง ไม่มีเส้นขอบด้านข้าง** เพื่อให้บล็อกอาหรับทั้งหมดใช้ภาษาภาพเดียวกัน):
```css
.ar-feature{
  font-family:'Amiri',serif; direction:rtl; text-align:center;
  font-size:1.6rem; line-height:2.1; color:#f5f1ea;
  padding:24px 24px; margin:28px 0;
  background:rgba(255,255,255,0.02);
}
.ar-translation{ color:#cfc8bb; margin:0 0 24px; }
```
> หมายเหตุ: `.ar-feature` คือบล็อก "สะอาด" (กึ่งกลาง ไม่มีลวดลาย) ส่วน `.aya-block` / `.hadith-block` (ดู B.2.1) คือชั้น "ยกระดับ" สำหรับอายะฮ์/หะดีษ = กึ่งกลาง + ลายจุดประดับ + แพดดิงมากกว่า ในหน้าอ่านธีมสว่าง (`.article-light`) สี `.ar-feature` = `#1a1612` พื้น `rgba(0,0,0,0.03)`

### B.2.1 บล็อกแบบยกระดับสำหรับ "อายะฮ์ / หะดีษ" (`.aya-block` / `.hadith-block`)
ตัวบทปฐมภูมิที่สำคัญที่สุด (อายะฮ์อัลกุรอาน และหะดีษตัวบท) ให้ใช้บล็อกยกระดับนี้แทน `.ar-feature` เพื่อให้เด่นเป็นพิเศษ ทั้งสองคลาสใช้ดีไซน์เดียวกัน (อาหรับจัดกึ่งกลาง Amiri ~2.2rem, พื้นหลังไล่เฉดแดงจาง, ลายจุดแดงประดับบน-ล่าง) แต่**แยกชื่อคลาส**ไว้เพื่อปรับแต่งต่างกันได้ในอนาคต

กฎของบล็อกนี้ (สำคัญ):
- **ห้ามมีป้ายกำกับด้านบน** (เช่น "آيَة" / "حَدِيث" / "อายะฮ์" / "หะดีษ") — บริบทภาษาไทยรอบ ๆ บอกผู้อ่านอยู่แล้วว่ากำลังจะยกอะไรมา บล็อกบรรจุเพียง: **บรรทัดอาหรับ → บรรทัดแหล่งอ้างอิง** เท่านั้น
- **บรรทัดแหล่งอ้างอิง** อยู่ใต้ตัวอาหรับ จัดกึ่งกลาง IBM Plex Sans Thai 11px ตัวพิมพ์ใหญ่ letter-spacing 0.2em สี muted (เช่น `สูเราะฮ์อัลบะเกาะเราะฮ์ · อายะฮ์ที่ 189` หรือ `บันทึกโดยอัลบุคอรีย์ และมุสลิม`)
- **คำแปลไทยอยู่นอกบล็อกและต่อท้ายบล็อก** เป็นย่อหน้า body ปกติ (`<p>` ชิดซ้าย สี --text ขนาด body ไม่กึ่งกลาง ไม่เอียง) อ่านต่อเนื่องเป็นเนื้อความบทความ ไม่ใช่แคปชัน

```html
<div class="aya-block">
  <p class="block-ar" lang="ar" dir="rtl">يسألونك عن الأهلة قل هي مواقيت للناس والحج</p>
  <p class="block-source">สูเราะฮ์อัลบะเกาะเราะฮ์ · อายะฮ์ที่ 189</p>
</div>
<p>{พวกเขาจะถามเจ้าเกี่ยวกับดวงจันทร์ข้างขึ้น ...}</p>

<div class="hadith-block">
  <p class="block-ar" lang="ar" dir="rtl">إِنَّا أُمَّةٌ أُمِّيَّةٌ لاَ نَكْتُبُ وَلاَ نَحْسُبُ...</p>
  <p class="block-source">บันทึกโดยอัลบุคอรีย์ และมุสลิม</p>
</div>
<p>“เราเป็นประชาชาติที่ไม่รู้หนังสือ ...”</p>
```
CSS อยู่ใน `article.css` (global — ทุกบทความ reuse ได้) ส่วน `.ar-feature` เดิมยังคงใช้กับตัวบทแกนอื่น ๆ ที่ไม่ใช่อายะฮ์/หะดีษ (เช่น คำถามที่ส่งถึงปราชญ์ หรือคำพูดอุละมาอ์ที่โชว์เต็ม)
